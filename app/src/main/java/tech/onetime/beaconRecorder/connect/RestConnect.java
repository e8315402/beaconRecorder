package tech.onetime.beaconRecorder.connect;
...
import tech.onetime.beaconRecorder.utils.Config;
import tech.onetime.beaconRecorder.utils.PrefRW;
...
//    }
    ...
    public String getAppVersion(Context ctx) {
        return tech.onetime.beaconRecorder.utils.Config.getAppVersionName(ctx);
    }
