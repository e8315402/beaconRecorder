package tech.onetime.beaconRecoder.connect;
...
import tech.onetime.beaconRecoder.utils.Config;
import tech.onetime.beaconRecoder.utils.PrefRW;
...
//    }
    ...
    public String getAppVersion(Context ctx) {
        return tech.onetime.beaconRecoder.utils.Config.getAppVersionName(ctx);
    }
